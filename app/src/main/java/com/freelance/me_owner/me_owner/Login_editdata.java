...
public class Login_editdata extends FragmentActivity implements OnMapReadyCallback,
    ...
    EditText no_hp;
    EditText deskripsi;
    TextView id_pemilik,id_pemilik_bns,id_tmb, lat, lng, datagambar;
    int success;
    SharedPreferences sharedpreferences;
    String id,id_tambalban;
    ...
    //save
    private static final String TAG = Login_editdata.class.getSimpleName();
    private String UPLOAD_URL = "https://official-menambal.000webhostapp.com/android/me-nambal/edit_pemilik.php";

    private static final String TAG_SUCCESS = "success";
    private static final String TAG_MESSAGE = "message";
    private String KEY_IMAGE = "gambar";
    private String KEY_IMAGE2 = "data_gambar";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.login_editdata_main);
        ...
        jenis_usaha = (TextView) findViewById(R.id.jenis_usaha_option);
        ...
        datagambar    = (TextView) findViewById(R.id.datagambar);

        mtakepicture = (CardView) findViewById(R.id.takepicture);
        imageView = (NetworkImageView) findViewById(R.id.imageViewtakepicture);
        ...
        mtakelatlng.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(Login_editdata.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {

                    return;
                }
                client.getLastLocation().addOnSuccessListener(Login_editdata.this, new OnSuccessListener<Location>() {
                    @Override
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Toast.makeText(Login_editdata.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG).show();
                                kosong();
                                onBackPressed();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        //menampilkan toast
                        Toast.makeText(Login_editdata.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(KEY_JENIS_USAHA, jenis_usaha.getText().toString().trim());
                ...
                if(lat.getText().toString() != null && lng.getText().toString() != null){
                    params.put(KEY_LAT, lat.getText().toString().trim());
                    params.put(KEY_LNG, lng.getText().toString().trim());
                }else{
                ...
                params.put(KEY_ID, id_tmb.getText().toString().trim());
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Login_editdata.this);
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == REQUEST_CAMERA) {
                ...
                try {
                    ...
                    bitmap = MediaStore.Images.Media.getBitmap(Login_editdata.this.getContentResolver(), data.getData());
                    setToImageView(getResizedBitmap(bitmap, max_resolution_image));
                } catch (IOException e) {
                    e.printStackTrace();
                }
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url_detail, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    String Nama               = obj.getString(KEY_NAME);
                    String Jenis_usaha        = obj.getString(KEY_JENIS_USAHA);
                    String Alamat             = obj.getString(KEY_ALAMAT);
                    String Jam_operasional    = obj.getString(KEY_JAM_OPERASIONAL);
                    String Harga              = obj.getString(KEY_HARGA);
                    String No_hp              = obj.getString(KEY_NO_HP);
                    String Deskripsi          = obj.getString(KEY_DESKRIPSI);
                    String Gambar             = obj.getString(KEY_IMAGE);
                    String Data_Gambar        = obj.getString(KEY_IMAGE2);
                    String LatTMB             = obj.getString(KEY_LAT);
                    String LngTMB             = obj.getString(KEY_LNG);
                    String Idtmb              = obj.getString(KEY_ID);

                    nama.setText(Nama);
                    jenis_usaha.setText(Jenis_usaha);
                    alamat.setText(Alamat);
                    jamoperasional.setText(Jam_operasional);
                    harga.setText(Harga);
                    no_hp.setText(No_hp);
                    ...
                    if (obj.getString(KEY_IMAGE)!=""){
                        imageView.setImageUrl(Gambar, imageLoader);
                        datagambar.setText(Data_Gambar);
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Login_editdata.this,
    ...
    private void getMarkers() {
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Login_editdata.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        }){
            @Override
            protected Map<String, String> getParams() {
